...
<p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;"><strong><span style="font-size: 24px;">Hello there,</span></strong></p>
<p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 14px;"><span style="font-size: 14px;">Please click on the button to complete the verification process for <strong>xxxxxx@xxxx.xxx:</strong></span></span></p>
</div>
</div>
...
<p style="margin: 0; font-size: 14px; line-height: 1.8; word-break: break-word; mso-line-height-alt: 25px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 14px;">Hello, ${usernew.username}</span></p>
<p style="margin: 0; font-size: 14px; line-height: 1.8; word-break: break-word; mso-line-height-alt: 25px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 14px;">Please click the following link to verify your account</span></p>
 <a href="${DOMAIN}/users/verify-now/${usernew.verificationCode}">Verify Now</a>
...
<div style="font-size:1px;line-height:10px"> </div><img align="center" alt="Image" border="0" class="center" src="images/icon_mail_white.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 20px; max-width: 100%; display: block;" title="Image" width="20"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 0;" valign="top">
<a href="
...
router.post(
    ...
    async(req, res) => {
        try {
            ...
            let isverified = true;
            let paassword = bcryptjs.hash(req.body.password, 10);
            User.findOne({ email: req.body.email }, async(err, result) => {
                ...
                if (!(result.verified === isverified)) {
                    ...
                    res.status(403).json("email is not verified ..please verify");
                } else {
    ...
    async(req, res) => {
        try {
            ...
            if (user.verified != isverified) {
                ...
                bcryptjs.compare(req.body.password, user.password, async(err, isMatch) => {
                    if (err) throw err;
                    if (isMatch) {
                        let token = await user.generateJWT();
                        let isver = true;
